...
const benefits = [
  {
    ...
    description:
      'Access to all our beautifully designed workspaces across the city',
  },
  {
    icon: Users,
...
const testimonials = [
  {
    ...
    quote:
      'CreatrixSpace transformed my productivity. The environment is inspiring and the community is incredibly supportive.',
    rating: 5,
  },
  {
    name: 'Rajesh Thapa',
    ...
    quote:
      'The Professional membership gave me everything I needed to scale my business. Highly recommended!',
    rating: 5,
  },
  {
    name: 'Sophia Chen',
    ...
    quote:
      'Best investment I made for my career. The networking opportunities alone are worth the membership.',
    rating: 5,
  },
]
...
export function MembershipPage() {
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="section-padding bg-gradient-to-br from-bg via-bg to-clay/5 relative">
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-fg-2 mb-8 leading-relaxed">
              Unlock your potential with flexible membership plans designed for
              modern professionals. Experience premium workspaces, vibrant
              community, and unmatched convenience.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-sm text-fg-2">{stat.label}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-fg-2 max-w-2xl mx-auto">
              Flexible membership options that grow with your needs. All plans
              include access to our premium amenities.
            </p>
          </motion.div>
                ...
                >
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                      <Badge className="bg-clay text-fg-on-ink-1 px-4 py-1">
                  ...
                  <Card
                    className={`h-full ${plan.popular ? 'border-clay shadow-lg ring-1 ring-primary/20' : ''}`}
                  >
                    <CardHeader className="text-center pb-4">
                      <div
                        className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${plan.gradient} p-4 mx-auto mb-4 shadow-lg`}
                      >
                      ...
                      <p className="text-fg-2">{plan.subtitle}</p>
                    </CardHeader>
                    ...
                    <CardContent className="pt-0">
                      <div className="text-center mb-6">
                        ...
                        <div className="flex items-center justify-center gap-2 mb-2">
                          ...
                          <span className="text-fg-2">/{plan.period}</span>
                        </div>
                        {plan.originalPrice && (
                      ...
                      <div className="space-y-4 mb-6">
                        ...
                        {plan.limitations.length > 0 && (
                          <div>
                            <h4 className="font-semibold mb-3 text-fg-2">
                              Limitations:
                            </h4>
                            <ul className="space-y-2">
                      ...
                      <Button
                        size="lg"
                        className={`w-full ${plan.popular ? 'bg-clay hover:bg-clay/90' : ''}`}
      ...
      <section className="section-padding bg-bg-band/30">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-fg-2 max-w-2xl mx-auto">
              More than just a workspace - it's a community designed to help you
              succeed.
            </p>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-fg-2 max-w-2xl mx-auto">
              Join hundreds of professionals who have transformed their work
              experience with CreatrixSpace.
            </p>
          </motion.div>
              ...
              >
                <Card className="h-full">
                  <CardContent className="p-6">
                    ...
                    <blockquote className="text-fg-2 mb-6 leading-relaxed">
                      "{testimonial.quote}"
                    </blockquote>
      ...
      {/* CTA Section */}
      <section className="section-padding bg-gradient-to-r from-clay to-clay/80 text-white">
        <div className="container">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Join CreatrixSpace today and discover what it means to work in an
              environment designed for success. Start with a day pass or dive
              into full membership.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" asChild>
                <Link to={ROUTES.BOOKING}>Start Free Tour</Link>
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="bg-transparent border-white text-white hover:bg-white hover:text-clay"
                asChild
              >
