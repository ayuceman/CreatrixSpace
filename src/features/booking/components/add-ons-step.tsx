...
export function AddOnsStep() {
  const { bookingData, addOns, updateBookingData, nextStep, prevStep } =
    useBookingStore()
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
                    ...
                    <Label htmlFor={addon.id} className="flex-1 cursor-pointer">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-sm text-fg-2">/month</div>
                        </div>
                      </div>
                    </Label>
                  </div>
          ...
          <div className="p-4 border rounded-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-fg-2">/hour</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm text-fg-2">hours</span>
            </div>
          </div>
          ...
          <div className="p-4 border rounded-lg">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <Gift className="h-5 w-5 text-clay" />
                <div>
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-fg-2">/day per guest</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm text-fg-2">passes</span>
            </div>
          </div>
        </CardContent>
      </Card>
            ...
            <div className="space-y-2 text-sm">
              ...
              {bookingData.meetingRoomHours > 0 && (
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatCurrency(
                      getMeetingRoomHourPrice() * bookingData.meetingRoomHours,
                      'NPR'
                    )}
                  </span>
                </div>
              ...
              {bookingData.guestPasses > 0 && (
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatCurrency(
                      getGuestPassPrice() * bookingData.guestPasses,
                      'NPR'
                    )}
                  </span>
                </div>
